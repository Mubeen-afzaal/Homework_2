...
public class Homework_2 {
    public static void main(String[] args) {
        ...
        linearSearch(arr, 17); //near the beginning
        linearSearch(arr, 90); //near the end
        linearSearch(arr, 105); //doesn't exist
        IO.println("");
        IO.println("Binary Search Result:");
        binarySearch(mergeResult, 8); //near the beginning
        binarySearch(mergeResult, 90); // near the end
        binarySearch(mergeResult, 105); //doesn't exist
    }
